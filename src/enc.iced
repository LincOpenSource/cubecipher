...
exports.CURRENT_VERSION = CURRENT_VERSION = 1
...
# ### Encryptor
#
# The high-level Encryption engine for CubeCipher.  You should allocate one
...
class Encryptor extends Base
  ...
  # @method run
  #
  # The main point of entry into the CubeCipher Encryption system.  The 
